                                    		...
                                    		<div class="col-sm-12 widget" <?php if($type !== 'widget'){ ?>style="display:none;"<?php } ?>>
                                				<select class="demo-cs-multiselect widget_select" multiple >
                                					<option value="most_sold"
														<?php if(in_array('most_sold',$widget)){ echo 'selected';} ?>>
                                                        	<?php echo translate('most_sold');?>
                                                    </option>
                                					<option value="most_viewed"
														<?php if(in_array('most_viewed',$widget)){ echo 'selected';} ?>>
                                                        	<?php echo translate('most_viewed');?>
                                                    </option>
                                					<option value="latest"
														<?php if(in_array('latest',$widget)){ echo 'selected';} ?>>
