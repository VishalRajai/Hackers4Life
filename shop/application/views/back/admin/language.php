			...
			<div class="panel-body">
				<div class="tab-content">
					<div class="col-md-12" style="border-bottom: 1px solid #ebebeb;padding: 40px 5px 5px 5px;">
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt" onclick="ajax_modal('add_lang','<?php echo translate('add_language'); ?>','<?php echo translate('successfully_added!'); ?>','language_add','')"><?php echo translate('add_language');?></button>
